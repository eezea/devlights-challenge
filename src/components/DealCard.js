...
function DealCard(props) {
  return <div className='relative group
    ...
    hover:cursor-pointer hover:bg-stone-800 hover:border-rose-600 hover:shadow-lg hover:shadow-rose-600/50 ease-in duration-200'>
      <div className='absolute top-2 right-2 flex items-center justify-center text-center text-xs font-bold bg-rose-700 
      ...
      <span>⭐⭐⭐⭐⭐</span>
      <div className='flex-none flex flex-row items-center justify-center space-x-2 px-2 md:px-4 
        ...
        <span className='md:text-lg font-bold md:group-hover:text-xl ease-in duration-200'>${props.salePrice}</span>
      </div>
  </div>;
}
